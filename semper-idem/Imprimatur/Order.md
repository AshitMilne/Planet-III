...
**Sustain, Create, Transform**
Another way of looking at Hinduism's philosophical triad of Brahma, Vishnu, Shiva respectively they sustain, create and transform. This triad simplifies the prioritization of our objectives. There are only three objectives. In order of priority:

1. <u>Sustain</u>: Ourselves, and the whole of our physiology across all dimensions, as well as our Ecology. There is no other objective on par with this
2. <u>Create</u>: The change required in our circumstance which at a minimum involves creating relationships (community and partnership). This happens through the process of sustaining - we groom and prepare each other to fit the roles our community needs, all the while attentive to particular attributes which make us suitable for this or the other thing that needs creating
3. <u>Transform</u>: The incremental adjustment to what we have created that is a good thing that we wish to extend in some way, qualitatively or quantitatively through the Satyam, Shivam, Sundaram model above
